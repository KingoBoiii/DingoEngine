...
// by client code. It is the only place Jolt is named (alongside JoltPhysics3D.cpp),
// keeping it a private implementation detail of the engine (the same treatment as
// EnTT/Box2D).
